...
export const metadata = {
  ...
  title: "Konektly - Modern Hiring Marketplace",
  description: "Konektly is a direct hiring marketplace where businesses post short-term work and workers apply from their phone.",
  icons: {
    icon: '/logo.png',
    shortcut: '/logo.png',
    apple: '/logo.png',
