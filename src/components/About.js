...
const PLATFORM_FEATURES = [
  ...
  {
    title: 'Fast Hiring',
    description: 'Businesses review real applicants and choose the worker who fits the work.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const TRUST_BADGES = ['Phone Verification', 'Business Profiles', 'Worker Skills', 'Direct Hiring'];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black leading-tight mb-6 tracking-tight">
              The hiring layer<br />
              <span className="text-gray-400">for real-world work.</span>
            </h2>
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed mb-8">
              Konektly is built for the way work actually happens now: businesses post work with timing and location, while workers browse nearby opportunities and apply from their phone.
            </p>
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed mb-10">
              The platform supports worker and business onboarding, verification, applications, hiring, in-app messaging, and reviews without turning every hire into a long recruitment cycle.
            </p>
