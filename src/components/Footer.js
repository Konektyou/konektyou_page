        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 max-w-md leading-relaxed">
              A direct hiring marketplace for businesses and workers. Post short-term openings, apply for jobs, hire, message, and review in one place.
            </p>
            ...
            {/* App Store */}
            <div className="mt-6">
              <p className="text-xs text-gray-500 mb-3 uppercase tracking-wide">Available on</p>
              <a
                href="https://apps.apple.com/us/app/konektly/id6761184414"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-black px-4 py-2.5 rounded-xl hover:bg-gray-100 transition-colors w-full sm:w-auto max-w-[200px]"
              >
