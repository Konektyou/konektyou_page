  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between px-4 py-2 h-12">
          ...
          <div className="flex items-center gap-2 relative" ref={dropdownRef}>
            <div className="text-right hidden sm:block">
              <p className="text-xs font-medium text-gray-900">{providerData?.name || 'Provider'}</p>
              <p className="text-[10px] text-gray-500">Service Provider</p>
            </div>
            <button
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to logout? You will need to login again to access your provider account."
        confirmText="Logout"
        cancelText="Cancel"
